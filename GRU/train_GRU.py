...
def main(_):
    ...
    wordembedding = np.load('GRU/data/vec.npy')

    print('reading training data')
    train_y = np.load('GRU/data/train_y.npy')
    train_word = np.load('GRU/data/train_word.npy')
    train_pos1 = np.load('GRU/data/train_pos1.npy')
    train_pos2 = np.load('GRU/data/train_pos2.npy')
